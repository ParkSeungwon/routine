...
export class MyTab extends Component {
  ...
  protected done(i:number) {//text enter done
    if (this.isTab) {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.foot}>
          <Button title='add tab' onPress={()=>{this.show_popup(true);}} style={styles.button} />
          <Button title='remove tab' onPress={this.show_confirm.bind(this, true)} style={styles.button} />
          <Button title='add' onPress={this.show_popup.bind(this, false)} style={styles.button} />
          <Button title='remove selected' onPress={this.show_confirm.bind(this, false)} style={styles.button} />
          <Button title='reset' onPress={this.reset.bind(this)} style={styles.button}/>
